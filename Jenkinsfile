				...
				dir(project_path) {
					script {
						...
						*/
						...
						bat "\"${MSBUILD}\" /t:package /p:Configuration=Release C:\Windows\System32\config\systemprofile\AppData\Local\Jenkins\.jenkins\workspace\MultibranchPipeline_2_Dev\MVCTestApp\MVCTestApp.csproj"
